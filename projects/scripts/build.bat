...
:: ----------------------------
cmd /c windres ..\..\src\galaxian-clone.rc -o ..\..\src\galaxian-clone.rc.data
:: .
:: > Generating project
:: --------------------------
cmd /c mingw32-make -f ..\..\src\Makefile ^
PROJECT_NAME=galaxian-clone ^
PROJECT_VERSION=1.0 ^
PROJECT_DESCRIPTION="" ^
PROJECT_INTERNAL_NAME=galaxian-clone ^
PROJECT_PLATFORM=PLATFORM_DESKTOP ^
PROJECT_SOURCE_FILES="galaxian-clone.c" ^
BUILD_MODE="RELEASE" ^
